                            ...
                            <div className="col-lg-4 col-md-6" key={enrolledCourse.id}>
                                <div className="single-courses-box">
                                    <div className="courses-image">
                                        <Link href="/sample/[id]" as={`/sample/${enrolledCourse.course.id}`}>
                                    ...
                                    <div className="courses-content">
                                        ...
                                        <h3>
                                            <Link href="/sample/[id]" as={`/sample/${enrolledCourse.course.id}`}>
                                                <a>{enrolledCourse.course.title.length > 40 
                                                ? 
                                                `${enrolledCourse.course.title.slice(0, 40)}...`
                                                :
                                        ...
                                        <p>{enrolledCourse.course.overview.length > 100 ? `${enrolledCourse.course.overview.slice(0, 100)}...`:enrolledCourse.course.overview}</p>

                                        <ul className="courses-box-footer d-flex justify-content-between align-items-center">
                                            <li>
                                                <i className='flaticon-agenda'></i> 0/{parseInt(enrolledCourse.course.lessons)} Chapters
                                            </li>
                                            <li>
