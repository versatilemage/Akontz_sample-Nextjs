...
export default async (req, res) => {
    ...
    let { name, gender, age, eduDetails, City, occupation, email, password, confirmPassword} = req.body
    try {
        ...
        res.status(200).send({message: "new teacher created successfully", data: newUser})
    } catch (error) {
        console.error(error)
